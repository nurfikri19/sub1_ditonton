  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => di.locator<HptvListNotifier>(),
        ),
        ChangeNotifierProvider(
          create: (_) => di.locator<HptvDetailNotifier>(),
        ),
        ChangeNotifierProvider(
          create: (_) => di.locator<HptvSearchNotifier>(),
        ),
        ChangeNotifierProvider(
          create: (_) => di.locator<TopRatedHptvNotifier>(),
        ),
        ChangeNotifierProvider(
          create: (_) => di.locator<PopularHptvNotifier>(),
        ),
        ChangeNotifierProvider(
          create: (_) => di.locator<WatchlistHptvNotifier>(),
        ),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
