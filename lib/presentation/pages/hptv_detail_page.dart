...
class _TvDetailPageState extends State<HptvDetailPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      Provider.of<HptvDetailNotifier>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<HptvDetailNotifier>(
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!isAddedWatchlistTv) {
                                  await Provider.of<HptvDetailNotifier>(
                                      context,
                                      listen: false)
                                      .addWatchlistTv(tv);
                                } else {
                                ...
                                final message =
                                    Provider.of<HptvDetailNotifier>(context,
                                        listen: false)
                                        .watchlistMessageTv;
