...
// in ditonton/test/presentation/provider/hptv/hptv_search_notifier_test.dart.
...
import 'package:ditonton/domain/usecases/hptv/search_hptv.dart' as _i4;
...
class MockSearchHptv extends _i1.Mock implements _i4.SearchHptv {
  MockSearchHptv() {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Hptv>>> execute(String? query) =>
