...
import 'watchlist_hptv_notifier_test.mocks.dart';

@GenerateMocks([GetWatchlistHptv])
void main() {
  late WatchlistHptvNotifier provider;
  late MockGetWatchlistHptv mockGetWatchlistTv;
  late int listenerCallCount;

  setUp(() {
    listenerCallCount = 0;
    mockGetWatchlistTv = MockGetWatchlistHptv();
    provider = WatchlistHptvNotifier(
