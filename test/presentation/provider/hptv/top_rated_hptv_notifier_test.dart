...
import 'top_rated_hptv_notifier_test.mocks.dart';

@GenerateMocks([GetTopRatedHptv])
void main() {
  late MockGetTopRatedHptv mockGetTopRatedTv;
  late TopRatedHptvNotifier notifier;
  late int listenerCallCount;

  setUp(() {
    listenerCallCount = 0;
    mockGetTopRatedTv = MockGetTopRatedHptv();
    notifier = TopRatedHptvNotifier(getTopRatedTv: mockGetTopRatedTv)
      ..addListener(() {
        listenerCallCount++;
      });
  });
