...
void main() {
  late HptvRepositoryImpl repository;
  late MockHptvRemoteDataSource mockRemoteDataSource;
  late MockHptvLocalDataSource mockLocalDataSource;

  setUp(() {
    mockRemoteDataSource = MockHptvRemoteDataSource();
    mockLocalDataSource = MockHptvLocalDataSource();
    repository = HptvRepositoryImpl(
      remoteDataSource: mockRemoteDataSource,
      localDataSource: mockLocalDataSource,
    );
  });

  final tTvModel = HptvModel(
  ...
  final tTvModelList = <HptvModel>[tTvModel];
  ...
  group('Get Tv Detail', () {
    final tId = 1;
    final tTvResponse = HptvDetailResponse(
